...
var music='${Branch.music}';
var quickCheckBox='${Branch.allowQuickBooking}';
...
$(document).ready(function(){ 
   $('.uip').click(function(){
     var chVal=$("#all").val();
     document.getElementById("quick").value=chVal;
  }); 
}); 
</script>
...
<div id="busn-page" class="busn-page">
          ...
          <form:input path="contactNo" id="phone-number" name="phone-number"  placeholder="Phone Number" required ="autofocus" maxlength="15" onkeyup="num(event,this)"  onblur="moblen()" />
          </li>
          <li><form:errors path="maxCapacity" cssClass="error"></form:errors></li>
          <li><form:errors path="contactNo" cssClass="error"></form:errors></li>
          <li><span id=contactNo style="display:none;" class="error" >Phone number can't be less than 10 digit.</span></li>  
          <li>
         ...
         <form:errors path="location.cityName" cssClass="error"></form:errors>
          ...
          <h3>Link Fast2Find to Your App</h3>
          <li>
          ...
          <li>
          <form:password path="login.password"  placeholder="Password" id="hr-opr"  maxlength="15" required ="autofocus"/>
          </li>
...
<ul>
<li>
          <h2>Please select Genre of Music typically played..</h2>
          </li>
...
<tr>
<td class="weakz"></td>
<td><form:errors path="operatingHours.startTime" cssClass="error"></form:errors></td>
<td> <form:errors path="operatingHours.endTime" cssClass="error"></form:errors></td>
</tr>
</tbody>
</table>
</div>
     <h4 class="detils">Please enter details of business via quick box or use calendar to input details</h4>
          ...
          <p></p>
         <li><form:errors path="eventRepeatDate" cssClass="error"></form:errors></li>
          <li id="text-area">
          ...
          <li class="check-all-tag">
           <form:checkbox path="allowQuickBooking" id="all" value="yes" />
           <input type="hidden" id="quick" name="allowQuickBooking" />
          ...
          <input type="submit" id="submit-detils" value="Submit Details"/>
          </li>
