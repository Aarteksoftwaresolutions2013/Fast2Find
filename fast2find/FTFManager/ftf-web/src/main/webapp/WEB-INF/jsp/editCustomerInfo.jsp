...
<script type="text/javascript" src="js/common.js"></script>
 ...
 <script type="text/javascript" src="js/jsp-js/editCustomerInfo.js"></script>
...
<!---------------------singup_global ------------------------>
      ...
      <h3>${successMsg}</h3>
      <h2>My Account</h2>
      <form:form action="businessAndEventInformationEdit.do" modelAttribute="BusinessAndEventInformation" method="POST" autocomplete="off" id="sign-gobal" class="sign-gobal">
