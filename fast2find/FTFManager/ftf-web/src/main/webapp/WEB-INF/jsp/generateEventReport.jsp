...
<link rel="stylesheet" type="text/css" href="http://www.highcharts.com/media/com_demo/highslide.css" />                                      
 <script type="text/javascript" src="../ftf-web/js/eventReport.js"></script>                                     
<script type="text/javascript" src="js/jsp-js/generateEventReport.js"></script>
</head>
<body>
<form:form method="POST"  modelAttribute="Branch" autocomplete="off">
 ...
 <form:select path="branchId" id="sign-gbal" onchange="clear_div()" >
						...
						<c:forEach items="${branchEventIdList}" var="branchList">
							<form:option value="${branchList[0]}" label="${branchList[1]}" />
						</c:forEach>
					</form:select></h4>
<p></p>
&nbsp;&nbsp;&nbsp;&nbsp;<input type="button"  value="7 Days" onclick="getEventWeeklyData()" id="event-pagesubmit"/>
<input type="button"  value="30 Days" onclick="getEventMonthlyData()" id="event-pagesubmit" />
<input type="button"  value="90 Days"  onclick="getEventThreeMonthlyData()"id="event-pagesubmit" />
<input type="button"  value="1 Year"  onclick="getEventYearlyData()" id="event-pagesubmit" />
