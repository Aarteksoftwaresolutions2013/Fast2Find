...
<script type="text/javascript" src="js/jsp-js/editEvent.js"></script>
...
<jsp:scriptlet>
      ...
      <h3>${message}</h3>
      <h2>Update Event<span class="right-up">Tally App Access to</span></h2>
        ...
        <ul class="form-a">
        <li>
        <div class="first"><label>Event or Pavillion Name</label>
        ...
        <li>
        <div class="first">
        <label>Special Event Kiosk Name</label>
        ...
        <li>
       <div class="first">
        <label>Event Owner First Name</label>
        ...
        <li><form:errors path="eventOwnerFName" cssClass="error" ></form:errors></li>
        <li><form:errors path="eventOwnerLName" cssClass="error" ></form:errors></li>
        ...
        <li>
       <div class="first">
        <label>Event Specific Location Address</label>
       ...
       <div class="last"><label>State/Province</label>
        ...
        <li>
        <div class="first"><label>Zip/Post Code</label>
      ...
      <form:option value="selected" selected="selected" label="Select Country" />
       ...
       <div class="first"><label>Email Address</label>
        ...
        <li>
       <div class="first"><label>Repeat Email Address</label>
        ...
        <li>
        <div class="first"><label>Max Capacity of Event</label>
        ...
        <li>
        <input type="submit" id="event-pagesubmit" value="Update Details" />
        </li>
        </ul>
        ...
        <li>
        <form:input path="login.password" autocomplate="off" placeholder="Password"  id="field-bb" required ="autofocus" maxlength="15" />
        </li>
